...
if ( ! function_exists( 'shop_elite_get_option' ) ) :
    /**
     ...
     */
    function shop_elite_get_option($key, $defaults = false) {
        ...
        if( true == $defaults && 'unset' === $key_value ){
            $default_values = shop_elite_get_default_customizer_values();
...
if ( ! function_exists( 'shop_elite_get_options' ) ) :
    /**
     ...
     */
    function shop_elite_get_options() {
        $default_values = shop_elite_get_default_customizer_values();
        $customizer_values = get_theme_mod( 'theme_options' );
