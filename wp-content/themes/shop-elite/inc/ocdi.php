 ...
 * @return array Files.
 */
function shop_elite_import_files() {
    return array(
        array(
            'import_file_name'             =>  esc_html__( 'Theme Demo Content', 'shop-elite' ),
            'local_import_file'            => trailingslashit( get_template_directory() ) . 'assets/data/shop-elite.xml',
            'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'assets/data/shop-elite.wie',
            'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'assets/data/shop-elite.dat',
        ),
    );
}
add_filter( 'pt-ocdi/import_files', 'shop_elite_import_files' );
...
function shop_elite_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'shop_elite_after_import_setup' );