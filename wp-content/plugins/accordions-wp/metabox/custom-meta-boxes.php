...
add_action( 'init', 'cmb_init_not_acc' );
 ...
 * @return array
 */
function _cmb_available_fields_not_acc() {
 ...
 */
function _cmb_field_class_for_type_not_acc( $type ) {

	$map = _cmb_available_fields_not_acc();
 ...
 * @return string $query
 */
function cmb_fix_meta_query_order_not_acc($query) {
...
if ( version_compare( get_bloginfo( 'version' ), '3.8', '<' ) )
	add_filter( 'query', 'cmb_fix_meta_query_order_not_acc', 1 ); 